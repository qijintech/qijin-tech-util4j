...
mvn -Dmybatis.generator.overwrite=true mybatis-generator:generate -pl util4j-practice

echo "开始生成Dao文件"

pack=tech.qijin.util4j.practice
artifactId=practice
...
function create_dao()
{
    ...
    echo "" >> $file
    import_mapper=${pack}.mapper.$mapper_class
    import_sqlprovider=${pack}.mapper.${sqlprovider}
    import_model=${pack}.model.${model}
...
dao_path=./util4j-practice/src/main/java/$pack_path/dao
model_path=./util4j-practice/src/main/java/$pack_path/model

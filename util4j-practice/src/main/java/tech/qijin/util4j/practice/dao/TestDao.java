...
public interface TestDao extends TestMapper {
	...
	int batchInsertOrUpdate(@Param("records") List<Test> records, @Param("columns") List<String> columns);
	...
	class SqlProvider {
		...
		private String genSqlForBatchInsert(List<Test> records) {
		...
		public String genSqlForBatchInsertOrUpdate(List<Test> records, List<String> columns) {
